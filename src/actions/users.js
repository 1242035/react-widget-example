...
export function validateEmail( validateEmailToken )
{
	...
	const request = axios.get( `${API_URL}/validateEmail/${validateEmailToken}` );
...
export function meFromToken( tokenFromStorage )
{
	...
	{
		method: 'get',
		url: `${API_URL}/me/from/token?token=${tokenFromStorage}`,
		headers:
		{
...
{
	const request = axios.post( `${API_URL}/users/signup`, formValues );
...
{
	const request = axios.post( `${API_URL}/users/signin`, formValues );
